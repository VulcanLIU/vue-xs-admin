...
const rules = reactive<FormRules<typeof ruleForm>>({
  username: [
    { required: true, trigger: "blur", message: t("sys.login.rules.userName") },
  ],
  password: [
    { required: true, trigger: "blur", message: t("sys.login.rules.password") },
  ],
});
  ...
  >
    ...
    <el-form-item class="enter-y">
      <div class="form-item-container">
        <el-checkbox
          v-model="checked"
          :label="$t('sys.login.rememberPassword')"
        />
