...
export const useBoardsStore = defineStore({
  ...
  getters: {
    ...
    getCurrentColumn: state => state.boards[state.selectedBoard]?.columns[state.selectedColumn],
    getTask: state => state.boards[state.selectedBoard]?.columns[state.selectedColumn]?.tasks[state.selectedTask],
    getColumnsNames: state => state.boards[state.selectedBoard]?.columns.map(c => c.name),
  },
  actions: {
